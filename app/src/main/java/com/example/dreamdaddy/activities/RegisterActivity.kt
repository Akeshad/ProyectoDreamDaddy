...
class RegisterActivity : AppCompatActivity() {
    ...
    private var datodato: Calendar = Calendar.getInstance()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editTextBirthDateRegister.setOnClickListener {
            val dpd = DatePickerDialog(this, DatePickerDialog.OnDateSetListener { view, mYear, mMonth, mDayOfMonth ->
                ...
                datodato.set(mYear, mMonth, mDayOfMonth)
                Toast.makeText(this, "" + mDayOfMonth + " " + mMonth + " " + mYear, Toast.LENGTH_SHORT).show()
            }, year, month, day)
